...
Const _fpr_adc = 1                                          'czêstotliwoœæ probkowania ADC 1s
...
Const _ocr1a = Fcrystal / _presc_timer_adc / _fpr_adc -1    'oblicz i oceñ
...
Ocr2a = 168                                                 'wstêpny wspó³czynik DC = 64/256 = 0,25; wartoœæ w rejestrze porównania timer2
Ocr2b = 128
...
Timer1 = 0
Ocr1a = _ocr1a
Ocr1b = &HFFFF                                              'ocr1b > ocr1a, aby najpierw by³o przerwanie porównania ocr1a
...
Dim W As Word                                               'wartoœæ po konwersji
...
Do                                                          'pocz¹tek petli Do - Loop
   ...
   If Ucsr0a.rxc0 = 1 Then                                  'gdy bit RXC0 ustawiony - odebrany bajt w UDR0
      ...
      If A = Asc( "i") Then Incr Ocr2b                      'gdy odebrano znak "i" - zwiêkszenie DC w gen. PWM - OCR2B
      If A = Asc( "d") Then Decr Ocr2b

      If A = Asc( "w") Then Ocr2b = Ocr2b + 8               'gdy odebrano znak "w" - zwiêkszenie DC w gen. PWM
